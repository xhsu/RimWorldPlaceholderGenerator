...
EXPORT namespace Style
{
	...
	inline constexpr auto Info = fmt::fg(fmt::color::light_gray) | fmt::bg(fmt::color::black);
	inline constexpr auto Skipping = fmt::fg(fmt::color::gray);
	inline constexpr auto Name = fmt::emphasis::underline | fmt::fg(fmt::color::cyan) | fmt::bg(fmt::color::black);
